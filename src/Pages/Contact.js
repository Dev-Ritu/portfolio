...
function Contact() {
  ...
  return (
    <main className="container mx-auto max-width section">
      ...
      <span className="text-center text-content text-xl font-light block text-xl font-semibold">or</span>
      <h3 className="text-center text-3xl md:text-4xl lg:text-6xl text-white font-semibold md:font-bold pt-2 md:py-6">
