      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-content text-xs md:text-sm font-light pl-1 text-bold">{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-content text-xs md:text-sm font-light pl-1 text-bold">{location}</p>
          </div>
        </div>
        <p className="text-content text-xs md:text-sm font-light pl-1 min-w-fit text-bold">{duration}</p>
      </div>
    </article>
  );
}
